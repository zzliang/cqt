package com.cqt.controller.system.onlinemanager;
...
public class OnlineManagerController extends BaseController {
	...
	public void delete(PrintWriter out){
		...
		if(!Jurisdiction.hasJurisdiction(menuUrl)){return;} //校验权限
	...
	public ModelAndView edit() throws Exception{
		...
		if(!Jurisdiction.hasJurisdiction(menuUrl)){return null;} //校验权限
