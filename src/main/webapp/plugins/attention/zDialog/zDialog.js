...
Dialog.prototype.create = function() {
	...
	var f = '  <table id="_DialogTable_{thisID}" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" border="0" style="font-size:12px; line-height:1.4;border-collapse: collapse;">    <tr id="_Draghandle_{thisID}" onselectstart="return false;" style="-moz-user-select: -moz-none; ' + (this.Drag ? "cursor: move;" : "") + '">      <td width="13" height="45" style="background: #fff;"><div style="width: 13px;"></div></td>      <td height="45" style="background: #fff; border-bottom: 1px solid #ececec;position:relative;"><div style="padding: 9px 0 0 4px;font-weight: normal; color:#b6b6b6; font-size:14px; text-align:center;"><span id="_Title_{thisID}" style=" font-size:14px; color: #b6b6b6;">' + this.Title + '</span></div>        <div id="_ButtonClose_{thisID}" onclick="fixProgress();Dialog.getInstance(\'{thisID}\').cancelButton.onclick.apply(Dialog.getInstance(\'{thisID}\').cancelButton,[]);" onmouseout="this.style.backgroundImage=\'url({IMAGESPATH}dialog_closebtn.gif)\'" onmouseover="" style="margin: 4px 0 0;*margin-top: 5px; position: absolute;top:8px; right:0; cursor: pointer; height: 17px; width: 28px; background: url({IMAGESPATH}dialog_closebtn.gif) no-repeat 0 0; background-size: auto 17px;' + (ielt7 ? "margin-top: 3px;" : "") + (this.ShowCloseButton ? "" : "display:none;") + '"></div></td>      <td width="13" height="45" style="background: #fff;"><div style="width: 13px;"><a id="_forTab_{thisID}" href="#;"></a></div></td>    </tr>    <tr valign="bottom">      <td width="13" style="background: #fff;"></td>      <td align="center"><table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff">          <tr id="_MessageRow_{thisID}" style="' + (this.ShowMessageRow ? "" : "display:none") + '">            <td valign="top" height="50"><table width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#eaece9 url({IMAGESPATH}dialog_bg.jpg) no-repeat scroll right top;" id="_MessageTable_{thisID}">                <tr>                  <td width="50" height="50" align="center"><img width="32" height="32" src="{IMAGESPATH}' + this.MessageIcon + '" id="_MessageIcon_{thisID}"/></td>                  <td align="left" style="line-height: 16px;"><div id="_MessageTitle_{thisID}" style="font-weight:bold">' + this.MessageTitle + '</div>                    <div id="_Message_{thisID}">' + this.Message + '</div></td>                </tr>              </table></td>          </tr>          <tr>            <td valign="top" align="center"><div id="_Container_{thisID}" style="position: relative; width: ' + this.Width + "px; height: " + this.Height + 'px;">                <div  style="position: absolute; height: 100%; width: 100%; display: none; background-color:#fff; opacity: 0.5;" id="_Covering_{thisID}">&nbsp;</div>	' + (function(k) {
		if (k.InnerHtml) {
			return k.InnerHtml
		}
		if (k.URL) {
...
Dialog.getBgdiv = function() {
	...
	if (!d) {
		...
		var c = '<div id="_DialogBGMask" style="position:absolute;background-color:#f0f0f0;opacity:0.7;filter:alpha(opacity=70);width:100%;height:100%;"></div>';
