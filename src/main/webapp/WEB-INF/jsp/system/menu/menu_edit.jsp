			...
			$(document).ready(function(){
					if($("#menuId").val()!=""){
						...
						if(parentId=="0"){
							...
							$("#form-field-radio3").attr("disabled",true);
							$("#form-field-radio1").attr("checked",false);
							$("#form-field-radio2").attr("checked",false);
							$("#form-field-radio3").attr("checked",false);
						}
					}
				});
				...
				function setMUR(){
					...
					if($("#parentId").val()=="0"){
						...
						$("#form-field-radio3").attr("disabled",false);
					}else{
	...
	<body>
		<form action="menu/edit.do" name="menuForm" id="menuForm" method="post">
			...
			<table style="text-align: center;">
				...
				<tr>
					<td>
						<label style="float:left;padding-left: 5px;"><input name="form-field-radio" id="form-field-radio1" onclick="setType('0');" <c:if test="${pd.menuType == '0' }">checked="checked"</c:if> type="radio" value="icon-edit"><span class="lbl">系统菜单</span></label>
						<label style="float:left;padding-left: 5px;"><input name="form-field-radio" id="form-field-radio2" onclick="setType('1');" <c:if test="${pd.menuType == '1' }">checked="checked"</c:if> type="radio" value="icon-edit"><span class="lbl">员工菜单</span></label>
						<label style="float:left;padding-left: 5px;"><input name="form-field-radio" id="form-field-radio3" onclick="setType('2');" <c:if test="${pd.menuType == '2' }">checked="checked"</c:if> type="radio" value="icon-edit"><span class="lbl">家长菜单</span></label>
					</td>
				</tr>
				<tr>
			...
			<div id="cqtwindow2" class="center" style="display:none"><br/><br/><br/><img src="static/images/jiazai.gif" /><br/><h4 class="lighter block green"></h4></div>
		</form>
	</body>
</html>