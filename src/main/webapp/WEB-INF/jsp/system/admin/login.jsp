		...
		<div id="loginbox">
			<form action="" method="post" name="loginForm" id="loginForm">
				...
				<div class="control-group">
					<div class="controls">
						<div class="main_input_box">
							<span class="add-on bg_lg"> <i><img height="37" src="static/login/user.png" /></i>
				...
				<div class="control-group">
					<div class="controls">
						<div class="main_input_box">
							<span class="add-on bg_ly"> <i><img height="37" src="static/login/suo.png" /></i>
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">Copyright © Bjcsa 2017</span></font>
				</div>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript">
		...
		function severCheck() {
			if (check()) {
				...
				//code:qq359291651fhtest,fh,testtestQQ359291651fh,fh,rmak
				var code = "qq359291651fh" + loginname + ",fh," + password + "QQ359291651fh" + ",fh," + $("#code").val();
				$.ajax({
					type : "POST",
					url : 'login_login',
					data : {
