...
<body>
	<form action="classes/${msg }.do" name="classesForm" id="classesForm" method="post">
		<input type="hidden" name="classesId" id="classesId" value="${classes.classesId }"/>
		<div id="cqtwindow">
		<table>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="year" id="year" value="${classes.year }" /></td>
			</tr>
